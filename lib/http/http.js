...
var Http = {
  ...
  execute: function (config) {
    ...
    //appCookie登录
    if(!TokenStorage.get() && navigator.userAgent.indexOf('Platform/') != -1 && navigator.userAgent.indexOf('version/3.0.0') == -1 && global.getCookie('appToken')){
    	TokenStorage.set(global.getCookie('appToken'))
    }
    if(TokenStorage.get()){
